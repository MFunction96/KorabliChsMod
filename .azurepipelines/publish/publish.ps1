...
if ([string]::IsNullOrEmpty($Proxy)) {
	curl -sSL -o $publishFolder/windowsdesktop-runtime-win-x64.zip https://aka.ms/dotnet/8.0/windowsdesktop-runtime-win-x64.zip -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 Edge/16.16299" --connect-timeout 60 --max-time 60 --retry 5 --retry-delay 5 --retry-max-time 60
} else {
